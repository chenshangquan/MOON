...
enum EmEventType
{
	...
	emEventTypemoontoolSend, //moontool发送到moon90消息
	emEventTypemoontoolRecv, //moontool接收到moon90消息
};
...
public: 
   ...
   /*=============================================================================
    ...
    2011/04/23  1.0     俞锦锦  创建
    =============================================================================*/
	static void ForcePrtMsg( u32 dwMsgID, EmEventType emEventType ,char * format,...  );
    ...
    2011/04/23  1.0     俞锦锦  创建
    =============================================================================*/
	static void PrintMsg( u32 dwMsgID, EmEventType emEventType, char * format,... );
