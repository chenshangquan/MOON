...
/*====================================================================
函数名	AecMp3RefSet
功能    ：一幀MP3的回声抵消参考数据写入缓冲区。
使用算法：
参数说明：pRefBuf：一幀参考数据，单声道，288个点，
...
/*====================================================================
函数名	AecG722RefSet
功能    ：一幀G722的回声抵消参考数据写入缓冲区。8K
使用算法：
参数说明：pRefBuf：一幀参考数据，数据长度为AEC_G72_BUF_LENGTH/2 288点
		  pSubHandle,AEC句柄
