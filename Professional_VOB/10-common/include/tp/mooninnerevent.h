...
#undef _h_eventtpsys_h__

#include "innereventmoon.h"
#undef  _h_innereventmoon_h__
...
#ifndef _h_umsinnerevent_h__
#define _h_umsinnerevent_h__


#endif // _h_umsinnerevent_h__
