 ...
 *   
 *      cnc => cns 
 */_event(  ev_Cn_centreCurNameNty      )
   _body(TCentreCurName, MAX_CURTAIN_NUM)
   _body(u8			   , 1              )
   _ev_end
...
//    _ev_end
//    
//    _event(  ev_cns_centreTVAudVisModeTimer  )
//    _ev_end
// 
//    _event(  ev_cns_centreTVDisPlayTimer  )
//    _ev_end
// 
//    _event(  ev_cns_centreTVInputSelTimer  )
//    _ev_end
