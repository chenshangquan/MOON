 ...
 */_event( ev_tppSetSendAddrCmd )
   ...
   *[消息方向]
   *cn  = > cnmpctrl
   */_event( ev_tppSetPipModeTime_Cmd )
   _body ( u8,               1    )
   _ev_end
 ...
 *[消息方向]
 *cnmpctrl  = > cnmpctrl
 */_event( ev_timer_tpppipmodestatis1 )
   _ev_end
   _event( ev_timer_tpppipmodestatis2 )
   _ev_end
   _event( ev_timer_tpppipmodestatis3 )
   _ev_end
