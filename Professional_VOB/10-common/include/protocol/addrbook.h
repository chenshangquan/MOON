...
*/
	...
	*/
	...
	====================================================================
	*/
	BOOL ModifyAddrEntry( const CAddrEntry &cAddrEntry );
	...
	====================================================================
	*/
	BOOL ModifyAddrGroup( const CAddrMultiSetEntry &cAddrMultiSetEntry );
	...
	*/
	...
	====================================================================
	*/
	BOOL SaveAddrBook( const char* pchSavePath = NULL, BOOL32 bIsRateIsNetOrder = TRUE );
