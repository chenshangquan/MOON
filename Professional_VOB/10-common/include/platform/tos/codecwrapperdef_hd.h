...
******************************************************************************/
#ifndef _CODECWRAPPER_DEF_HD_TOS_H_   //2013-3-26
#define _CODECWRAPPER_DEF_HD_TOS_H_
...
enum
{
	...
	VID_OUTTYPE_SXGAPLUS60	  //固定按SXGA+ 60HZ输出 1680x1050
};
...
#define AUDIO_SPEAKER0              0x00000100//扬声器
...
typedef struct tagVideoEncParam
{
    ...
    u16   m_dwMaxKeyFrameInterval/*m_byMaxKeyFrameInterval*/;  /*I帧间最大P帧数目*/ //2013-3-11
