...
#define NIP_E1_ADD_SIGNAL 	NIP_E1_BASE + 19
#define NIP_E1_DEL_SIGNAL 	NIP_E1_BASE + 20
#define NIP_E1_GET_SIGNAL 	NIP_E1_BASE + 21
...
extern int nip_e1_set_signal(char *, int, char *, int);
extern int nip_e1_get_info(char *, int, char *);
extern int nip_e1_get_mode(char *, int, char *);
extern int nip_e1_get_fcs(char *, int, char *);
extern int nip_e1_get_clock(char *, int, char *);
extern int nip_e1_get_loopback(char *, int, char *);
extern int nip_e1_get_signal(char *, int, char *);
