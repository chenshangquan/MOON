...
#define IF_E_PREFIX_LEN_INVALID_FMT     "%% Prefix length shouldn't be 32 or 31%s"
#define IF_E_PREFIX_LEN_INVALID_FMT_C   "%%掩码长度不能是32或31%s"
...
#define IF_E_ADDR_EXIST_FMT     "%% Secondary can't be same as primary%s"
#define IF_E_ADDR_EXIST_FMT_C   "%%地址已经配置%s"
