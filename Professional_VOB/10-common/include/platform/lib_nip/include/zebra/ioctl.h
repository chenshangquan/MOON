...
#ifdef ZHZS_NETDEVICE_BANDWIDTH_NEW 
void if_get_bandwidth (struct interface *);
int if_rechange_bandwidth (struct interface *ifp);
int if_set_bandwidth (struct interface *ifp, unsigned bw);
#endif /* ZHZS_NETDEVICE_BANDWIDTH */
int if_get_loopback_status (struct interface *);
int if_get_line_status (struct interface *ifp);
int if_set_queue_len (struct interface *ifp, unsigned long  qlen);
int if_get_queue_len (struct interface *ifp, unsigned long *qlen);
