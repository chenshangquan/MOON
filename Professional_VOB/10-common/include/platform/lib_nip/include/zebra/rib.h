...
int
static_delete_ipv4_node (struct route_node *rn, struct static_ipv4 *si);
...
/* zhuzhm : fpr api */
int zebra_static_ipv4 (int add_cmd, char *dest_str, char *mask_str, 
                                        char *gate_str, char *distance_str, int *errid);
