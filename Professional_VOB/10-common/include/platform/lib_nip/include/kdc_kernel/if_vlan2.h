...
struct vlan_dev_info {
	...
	struct dev_mc_list *old_mc_list;  /* old multi-cast list for the VLAN interface..
                                           ...
                                           */
#ifdef KDC_SUB_VLAN_MOD
    int debug_vlan_kdc;     /* for vlan debug  packets kdc vlan*/
#endif /* KDC_SUB_VLAN_MOD */
...
/* kdc vlan*/
#ifdef KDC_SUB_VLAN_MOD
#define DEBUG_VLAN_PACKET_KDC         1
#define NO_DEBUG_VLAN_PACKET_KDC      2
#endif /* KDC_SUB_VLAN_MOD */
...
#ifdef KDC_SUB_VLAN_MOD
	SET_VLAN_DEBUG,   /* kdc vlan */
	UNSET_VLAN_DEBUG,  /* kdc vlan */
	ADD_VLAN_NO_ADD_GRP_CMD,
	ADD_VLAN_ADD_GRP_CMD,
	DEL_VLAN_NO_DEL_GRP_CMD,
	DEL_VLAN_DEL_GRP_CMD
#endif /* KDC_SUB_VLAN_MOD */
};
...
enum vlan_name_types {
	...
	VLAN_NAME_TYPE_FROM_NIP,    /* kdc vlan ,
	                               name from nip independence with vlan ID */
...
struct vlan_ioctl_args {
	...
	char device1[24];
#ifdef KDC_SUB_VLAN_MOD
    /* kdc vlan ,name from nip independence with vlan ID */	
	char net_dev_name[24];
#endif /* KDC_SUB_VLAN_MOD */
