...
_hint_body( emChineseSB, "VOD 登录超时" )
_hint_end
...
_hint_body( emChineseSB, "对端不支持当前格式和分辨率下的双流，或者对端只允许发言人发起双流" )
_hint_end
...
_hint_body( emChineseSB, "网口设置成功, 已启用网口1" )
_hint_end
...
_hint_body( emChineseSB, "网口设置成功, 已启用网口2" )
_hint_end
