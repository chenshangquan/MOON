...
public:
    ...
    virtual void LineUp(int nCyLine = 8);
    virtual void LineDown(int nCyLine = 8);
	virtual void LineLeft(int nCyLine = 8);
	virtual void LineRight(int nCyLine = 8);
    virtual void PageUp();
...
******************************************************************************/
class UILIB_API CScrollContainerUI : public CContainerUI
{
public:
	CScrollContainerUI();
	...
	void SetImageXY(SIZE szImgXY){ m_szImgXY = szImgXY;};
