...
{
	/*CStdString*/tString strPropName;
	/*CStdString*/tString strPropValue;
	tagAttrib()
	{
		strPropName.clear();
		strPropValue.clear();
...
typedef  std::map<  tString/*CStdString*/ /*strCtlName*/,VcAttrib /*vcAttrib*/  > CtlsAttribMap; //控件属性map

typedef   std::map< tString/*CStdString*/ /*strCtrlName*/  , CtlsAttribMap /*vcAttrib*/ >   CaseMAP;//方案map
...
public: 
	...
	* @remarks	 
	...
	2013/4/24       1.0         俞锦锦      创建
    ******************************************************************************/
	 bool DoCase( const LPCTSTR szCaseName, CPaintManagerUI* pManager );
