...
void CRkcMsgDriver::MappingEventName()
{
    ...
    RKCMAPPING_HELPER( RK100_EVT_SET_CAM_NR, _T("RK100_EVT_SET_CAM_NR"));
    RKCMAPPING_HELPER( RK100_EVT_SET_CAM_NR_ACK, _T("RK100_EVT_SET_CAM_NR_ACK"));

    RKCMAPPING_HELPER( RK100_EVT_SET_CAM_Memory, _T("RK100_EVT_SET_CAM_Memory"));
    RKCMAPPING_HELPER( RK100_EVT_SET_CAM_Memory_ACK, _T("RK100_EVT_SET_CAM_Memory_ACK"));
