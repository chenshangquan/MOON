...
public:
    ...
    //获取板卡配置
    virtual u16 GetBrdInfoConfig();
    //获取板卡配置内容
    virtual u16 GetBrdInfoConfig(TRK100BrdInfo& tRK100BrdInfo);
...
protected:
    ...
    void OnGetBrdInfoConfigRsp(const CMessage& cMsg);
...
private:
    ...
    TRK100BrdInfo           m_tRK100BrdInfo;            //板卡
};
