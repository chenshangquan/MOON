...
// 	tagCMSConf& operator = (const tagCMSConf& tRhs)
// 	{
// // 		if(this == &tRhs)
// //             return *this;
// 		
// 		m_tplCnsList = tRhs.m_tplCnsList;
//         m_tAudmixList = tRhs.m_tAudmixList;
//         m_tplPollList = tRhs.m_tplPollList ;
// 
// 		TTPConfInfo::operator = (tRhs); 
// 		return *this;
// 	}
    ...
    {    
        ...
        for ( u16 i = 0; i < m_atEpList.m_wNum; i++ )
        {
            ...
            {    
                ...
                ZeroMemory(&this->m_atEpList.m_tCnsList[ i ].m_tAlias,sizeof(this->m_atEpList.m_tCnsList[ i ].m_tAlias));
                ...
                ZeroMemory(&this->m_atEpList.m_tCnsList[ m_atEpList.m_wNum - 1 ].m_tAlias,sizeof(this->m_atEpList.m_tCnsList[ m_atEpList.m_wNum - 1 ].m_tAlias));
                m_atEpList.m_wNum --;
