...
{
    { RGB(0x00, 0x00, 0x00),  _T("黑色"),     _T("Black")             },  
    { RGB(0x99, 0x33, 0x00),  _T("褐色"),     _T("Brown")             },
    { RGB(0x33, 0x33, 0x00),  _T("橄榄绿"),   _T("Dark Olive Green")  },  
    { RGB(0x00, 0x33, 0x00),  _T("深绿"),     _T("Dark Green")        },  
    { RGB(0x00, 0x33, 0x66),  _T("深灰蓝"),   _T("Dark Teal")         },  
    { RGB(0x00, 0x00, 0x80),  _T("深蓝"),     _T("Dark blue")         },  
    { RGB(0x33, 0x33, 0x99),  _T("靛蓝"),     _T("Indigo")            },  
    { RGB(0x33, 0x33, 0x33),  _T("灰色-80"),  _T("Dark grey")         },  
                                                                            
    { RGB(0x80, 0x00, 0x00),  _T("深红"),     _T("Dark red")          },
    { RGB(0xFF, 0x66, 0x00),  _T("桔黄"),     _T("Orange")            },
    { RGB(0x80, 0x80, 0x00),  _T("深黄"),     _T("Dark yellow")       },  
    { RGB(0x00, 0x80, 0x00),  _T("绿色"),     _T("Green")             },  
    { RGB(0x00, 0x80, 0x80),  _T("青色"),     _T("Teal")              },  
    { RGB(0x00, 0x00, 0xFF),  _T("蓝色"),     _T("Blue")              },  
    { RGB(0x66, 0x66, 0x99),  _T("蓝-灰"),    _T("Blue-grey")         },  
    { RGB(0x80, 0x80, 0x80),  _T("灰色-50"),  _T("Grey - 50")         },  
                                                                            
    { RGB(0xFF, 0x00, 0x00),  _T("红色"),     _T("Red")               },
    { RGB(0xFF, 0x99, 0x00),  _T("浅桔黄"),   _T("Light orange")      },  
    { RGB(0x33, 0xCC, 0x00),  _T("酸橙色"),   _T("Lime")              },  
    { RGB(0x33, 0x88, 0x66),  _T("海绿"),     _T("Sea green")         },  
    { RGB(0x33, 0xCC, 0xCC),  _T("宝石蓝"),   _T("Aqua")              },  
    { RGB(0x66, 0x99, 0xFF),  _T("浅蓝"),     _T("Light blue")        },  
    { RGB(0x80, 0x00, 0x80),  _T("紫色"),     _T("Violet")            },  
    { RGB(0x66, 0x66, 0x66),  _T("灰色-40"),  _T("Grey - 40")         },  
                                                                            
    { RGB(0xFF, 0x00, 0xFF),  _T("粉红"),     _T("Pink")              },
    { RGB(0xFF, 0xCC, 0x00),  _T("金色"),     _T("Gold")              },  
    { RGB(0xFF, 0xFF, 0x00),  _T("黄色"),     _T("Yellow")            },  
    { RGB(0x00, 0xFF, 0x00),  _T("鲜绿"),     _T("Bright green")      },  
    { RGB(0x00, 0xFF, 0xFF),  _T("青绿"),     _T("Turquoise")         },  
    { RGB(0x00, 0xCC, 0xFF),  _T("天蓝"),     _T("Skyblue")           },  
    { RGB(0x99, 0x33, 0x66),  _T("梅红"),     _T("Plum")              },  
    { RGB(0xC0, 0xC0, 0xC0),  _T("灰色-25"),  _T("Light grey")        },  
                                                                            
    { RGB(0xFF, 0x99, 0xCC),  _T("玫瑰红"),   _T("Rose")              },  
    { RGB(0xFF, 0xCC, 0x99),  _T("棕黄"),     _T("Tan")               },  
    { RGB(0xFF, 0xFF, 0x99),  _T("浅黄"),     _T("Light yellow")      },  
    { RGB(0x99, 0xFF, 0x99),  _T("浅绿"),     _T("Pale green ")       },  
    { RGB(0x99, 0xFF, 0xFF),  _T("浅青绿"),   _T("Pale turquoise")    },  
    { RGB(0x99, 0xCC, 0xFF),  _T("淡蓝"),     _T("Pale blue")         },  
    { RGB(0xCC, 0x99, 0xFF),  _T("淡紫"),     _T("Lavender")          },  
    { RGB(0xFF, 0xFF, 0xFF),  _T("白色"),     _T("White")             }   
...
void CColourPopup::OnActivateApp(BOOL bActive, DWORD hTask) 
{
	...
	if (!bActive)
    {
        ...
        ReleaseCapture();
        // 如果焦点移到另外的应用程序，则只需将此颜色选择框销毁，不需要通知父窗口
        if (!m_bChildWindowVisible)
            DestroyWindow();
    }
}
